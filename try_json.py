    ...
    try:
        with open(journal_file) as the_file:
            if example==0:
                ...
                f = open(journal_file.replace('json', 'csv'), 'w')
                ...
                for el in journal:
                    ...
                    n += 1
                f.close()
                print('{} Zeilen in Datei {} geschrieben'.format(n, journal_file.replace('json', 'csv')))

    except FileNotFoundError:
        print('Kann Datei nicht finden')
...
if __name__=='__main__':
    ...
    if len(sys.argv)>1:
        import_journalctl_data(sys.argv[1], 3)
    else:
        print('Dateiname als Aufrufparameter fehlt')
